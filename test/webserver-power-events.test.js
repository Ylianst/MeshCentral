...
const hasDatabaseFailure = require('../webserver/power-events.js').hasDatabaseFailure;
const createPowerEventsHandler = require('../webserver/power-events.js').createPowerEventsHandler;
