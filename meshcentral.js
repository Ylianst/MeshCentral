    ...
    InstallModules(['minimist'], function () {
        ...
        for (var i in config.domains) {
            ...
            if ((typeof config.domains[i].authstrategies == 'object')) {
                ...
                if ((typeof config.domains[i].authstrategies.oidc == 'object') && (typeof config.domains[i].authstrategies.oidc.clientid == 'string') && (typeof config.domains[i].authstrategies.oidc.clientsecret == 'string') && (passport.indexOf('passport-generic-oidc') == -1)) { passport.push('passport-generic-oidc'); }
