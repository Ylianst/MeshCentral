...
const hasDatabaseFailure = require('../../../webserver/realtime/relay-websocket.js').hasDatabaseFailure;
const hasRelayConnectivity = require('../../../webserver/realtime/relay-websocket.js').hasRelayConnectivity;
const isSelectedDeviceGroup = require('../../../webserver/realtime/relay-websocket.js').isSelectedDeviceGroup;
const openRecordingFile = require('../../../webserver/realtime/relay-websocket.js').openRecordingFile;
const closeRecordingFile = require('../../../webserver/realtime/relay-websocket.js').closeRecordingFile;
const setupSessionRecording = require('../../../webserver/realtime/relay-websocket.js').setupSessionRecording;
const routeToPeerServer = require('../../../webserver/realtime/relay-websocket.js').routeToPeerServer;
const finishSessionRecording = require('../../../webserver/realtime/relay-websocket.js').finishSessionRecording;
const logRelaySessionEnd = require('../../../webserver/realtime/relay-websocket.js').logRelaySessionEnd;
const writeOrQueueCiraRelayData = require('../../../webserver/realtime/relay-websocket.js').writeOrQueueCiraRelayData;
const flushCiraRelayData = require('../../../webserver/realtime/relay-websocket.js').flushCiraRelayData;
const closeCiraRelayTransport = require('../../../webserver/realtime/relay-websocket.js').closeCiraRelayTransport;
const setupCiraRelayTransport = require('../../../webserver/realtime/relay-websocket.js').setupCiraRelayTransport;
const setupDirectRelayTransport = require('../../../webserver/realtime/relay-websocket.js').setupDirectRelayTransport;
const createRelayWebSocketHandler = require('../../../webserver/realtime/relay-websocket.js').createRelayWebSocketHandler;
const recordRelayStartAndUserAccess = require('../../../webserver/realtime/relay-websocket.js').recordRelayStartAndUserAccess;
...
test('relay WebSocket handlers authorize nodes and open direct transports', function () {
    const connections = [];
    function FakeSocket() { }
    FakeSocket.prototype.setEncoding = function () { };
    FakeSocket.prototype.on = function () { };
    FakeSocket.prototype.connect = function (port, host, callback) { connections.push([port, host]); callback(); };
    const node = { _id: 'node//node1', meshid: 'mesh//main', host: '192.0.2.10', intelamt: { tls: 0, user: 'admin', pass: 'secret' } };
    const state = {
        db: { Get: function (nodeId, callback) { callback(null, [node]); } },
        GetNodeRights: function () { return 8; },
        parent: { debugLevel: 0 },
        net: { Socket: FakeSocket },
        interceptor: { CreateHttpInterceptor: function () { return {}; } },
        meshRelayHandler: { recordingEntry: function () { } }
    };
    const parent = {
        debug: function () { },
        multiServer: null,
        mpsserver: { GetConnectionToNode: function () { return null; } },
        GetConnectivityState: function () { return { connectivity: 4 }; }
    };
    const websocket = { _socket: { setKeepAlive: function () { }, resume: function () { } }, on: function () { } };
    const user = { name: 'Alice', access: Math.floor(Date.now() / 1000) };
    const handler = createRelayWebSocketHandler({ state: state, parent: parent, remoteControlRight: 8, getRandomPassword: function () { return 'session1'; }, tlsConstants: {} });
    handler(websocket, { clientIp: '192.0.2.1', query: { host: node._id, p: 1 } }, { id: '' }, user, null);
    assert.equal(websocket.id, 'session1');
    assert.deepEqual(connections, [[16992, '192.0.2.10']]);
});
