...
const hasOtherVerifiedUser = require('../../../../webserver/auth/account/email-account-utils.js').hasOtherVerifiedUser;
const hasDatabaseFailure = require('../../../../webserver/auth/account/email-account-utils.js').hasDatabaseFailure;
const createTemporaryPassword = require('../../../../webserver/auth/account/email-account-utils.js').createTemporaryPassword;
const getActiveUser = require('../../../../webserver/auth/account/email-account-utils.js').getActiveUser;
const hasEmailLinkCookie = require('../../../../webserver/auth/account/email-account-utils.js').hasEmailLinkCookie;
const hasAccountEmailRequest = require('../../../../webserver/auth/account/email-account-utils.js').hasAccountEmailRequest;
const resolveAccountEmail = require('../../../../webserver/auth/account/email-account-utils.js').resolveAccountEmail;
