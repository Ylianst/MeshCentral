...
const createDomainAssets = require('../../../webserver/domains/domain-assets.js').createDomainAssets;
const canAccessOtherUserImage = require('../../../webserver/domains/domain-assets.js').canAccessOtherUserImage;
