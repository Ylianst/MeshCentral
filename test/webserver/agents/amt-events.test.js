...
const hasDatabaseFailure = require('../../../webserver/agents/amt-events.js').hasDatabaseFailure;
const hasRandomBytesFailure = require('../../../webserver/agents/amt-events.js').hasRandomBytesFailure;
const createAmtEventHandler = require('../../../webserver/agents/amt-events.js').createAmtEventHandler;
