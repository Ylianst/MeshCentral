...
const createPushNotifications = require('../../../webserver/realtime/push-notifications.js').createPushNotifications;
const isValidFirebaseRelayData = require('../../../webserver/realtime/push-notifications.js').isValidFirebaseRelayData;
