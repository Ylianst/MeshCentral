    ...
    InstallModules(['minimist'], function () {
        ...
        for (var i in config.domains) {
            ...
            if ((typeof config.domains[i].authstrategies == 'object')) {
                ...
                if ((typeof config.domains[i].authstrategies.oidc == 'object') && (typeof config.domains[i].authstrategies.oidc.clientid == 'string') && (typeof config.domains[i].authstrategies.oidc.clientsecret == 'string') && (typeof config.domains[i].authstrategies.oidc.issuer == 'string') && (passport.indexOf('openid-client') == -1)) {
