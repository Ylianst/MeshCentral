...
const resolveUserWebState = require('../../../webserver/ui/user-web-state.js').resolveUserWebState;
const getUiViewMode = require('../../../webserver/ui/user-web-state.js').getUiViewMode;
