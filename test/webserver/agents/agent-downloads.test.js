...
const getSessionUser = require('../../../webserver/agents/agent-downloads.js').getSessionUser;
const hasDatabaseFailure = require('../../../webserver/agents/agent-downloads.js').hasDatabaseFailure;
const hasNodeAccess = require('../../../webserver/agents/agent-downloads.js').hasNodeAccess;
const getAgentInfo = require('../../../webserver/agents/agent-downloads.js').getAgentInfo;
const getMeshRelayUrl = require('../../../webserver/agents/agent-downloads.js').getMeshRelayUrl;
const getCoreDownloadUrl = require('../../../webserver/agents/agent-downloads.js').getCoreDownloadUrl;
const sendMeshCoreList = require('../../../webserver/agents/agent-downloads.js').sendMeshCoreList;
const sendMeshCore = require('../../../webserver/agents/agent-downloads.js').sendMeshCore;
const sendAgentList = require('../../../webserver/agents/agent-downloads.js').sendAgentList;
const sendAgentInstallScript = require('../../../webserver/agents/agent-downloads.js').sendAgentInstallScript;
const sendMeshCmd = require('../../../webserver/agents/agent-downloads.js').sendMeshCmd;
const sendMeshTool = require('../../../webserver/agents/agent-downloads.js').sendMeshTool;
const sendGenericMeshAction = require('../../../webserver/agents/agent-downloads.js').sendGenericMeshAction;
const sendRouteMeshAction = require('../../../webserver/agents/agent-downloads.js').sendRouteMeshAction;
const sendAgentSelfInstaller = require('../../../webserver/agents/agent-downloads.js').sendAgentSelfInstaller;
const sendAgentPdb = require('../../../webserver/agents/agent-downloads.js').sendAgentPdb;
const sendAgentBinary = require('../../../webserver/agents/agent-downloads.js').sendAgentBinary;
const sendCustomizedWindowsAgent = require('../../../webserver/agents/agent-downloads.js').sendCustomizedWindowsAgent;
const handleCoreDumpRequest = require('../../../webserver/agents/agent-downloads.js').handleCoreDumpRequest;
const createAgentDownloadHandler = require('../../../webserver/agents/agent-downloads.js').createAgentDownloadHandler;
